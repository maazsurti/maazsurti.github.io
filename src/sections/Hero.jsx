  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center px-[8vw] overflow-hidden">
      ...
      <div className="absolute w-[400px] h-[400px] rounded-full bottom-0 left-[-5%] pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(167,139,250,0.06) 0%, transparent 70%)', animation:'pulseGlow 5s ease-in-out infinite 1s' }} />
      ...
      <div className="flex items-center w-full gap-20 z-[1] flex-wrap py-24">
        ...
        <div className="flex-1 min-w-[300px]">
          ...
          <p className="font-outfit text-[17px] text-[#666] leading-[1.7] max-w-[480px] mb-10">
            Senior iOS developer specializing in{' '}
            <span className="text-[#ccc]">SwiftUI</span> &amp;{' '}
            <span className="text-[#ccc]">UIKit</span> — building performant, beautifully crafted native apps.
            Also shipping cross-platform with <span className="text-[#ccc]">Flutter</span>.
          </p>
          ...
          <div className="flex gap-10 mt-14">
            {[['6+','Apps on Store'],['500K+','Total Downloads'],['4.8★','Avg Rating']].map(([n,l]) => (
              <div key={l}>
                ...
                <div className="font-outfit text-[12px] text-[#444] mt-0.5">{l}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="flex-shrink-0 relative flex items-center justify-center">
          ...
          >
            ...
            <div className="absolute inset-0 rounded-[40px]"
              style={{ background:'linear-gradient(180deg,#0f0f2e,#07070f)' }}>
              <div className="absolute top-[60px] left-0 right-0 bottom-0 p-4 flex flex-col gap-2.5">
                ...
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <div>
                    <div className="h-[5px] w-[60px] rounded mb-1" style={{ background:'rgba(255,255,255,0.3)' }} />
                    <div className="h-[4px] w-10 rounded"           style={{ background:'rgba(255,255,255,0.1)' }} />
                  </div>
                </div>
                {/* Chart card */}
                <div className="h-[90px] rounded-[14px] p-3"
                  ...
                  <div className="h-[5px] w-4/5 rounded mb-2" style={{ background:'rgba(0,212,255,0.3)' }} />
                  <div className="h-[4px] w-3/5 rounded mb-1.5" style={{ background:'rgba(255,255,255,0.1)' }} />
                  <div className="h-6 rounded-[8px] mt-2"       style={{ background:'rgba(0,212,255,0.15)' }} />
                </div>
                {/* Mini icon grid */}
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 transition-opacity duration-300 pointer-events-none"
        ...
        <span className="font-mono text-[10px] text-[#333] tracking-[0.1em]">SCROLL</span>
        <div className="w-px h-10 animate-pulse-glow" style={{ background:'linear-gradient(#00d4ff,transparent)' }} />
      </div>
    </section>
  )
}
