  ...
  return (
    <section id="contact" className="relative z-[1]">
      <div className="rounded-[28px] border border-[#d8cec1] bg-brand-surface p-8 md:p-10 text-center">
        ...
        <h2
          className="font-outfit font-extrabold leading-[1.06] tracking-[-0.01em] mb-5 text-[#1f1b17]"
        ...
        <p className="font-outfit text-[15px] text-brand-dim leading-[1.7] mb-10 max-w-[620px] mx-auto">
          If you need an iOS app built or improved, send a quick note. I reply
          fast and get straight to the point.
        </p>
        ...
        <div className="flex gap-3 mt-5 justify-center flex-wrap">
          {[
            ["GitHub", "https://github.com/maazsurti"],
            ["LinkedIn", "https://www.linkedin.com/in/maaz-surti-aa77521a3/"],
            [
              "App Store",
              "https://apps.apple.com/id/developer/rcd-web-design-and-management/id1600523696",
            ],
          ].map(([label, href]) => (
            <a
              key={label}
